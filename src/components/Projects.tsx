...
export default function Projects() {
  ...
  const projects = [
    ...
    {
      id: 7,
      // messages only has projects.1..6, so we reuse 6.* for the 7th card.
      titleKey: '7.title',
      descKey: '7.desc',
      image: '/imags/image1.png',
      url: t.raw('7.url') as string,
    },
  ];
  ...
  return (
    <section
      id="portfolio"
      className="min-h-screen py-32 px-6 bg-secondary relative overflow-hidden"
    >
